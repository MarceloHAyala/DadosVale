...
- **W7 Grupo B (01/06/2026 — Análises complementares):** ver `PLANEJAMENTO.md` → seção W7
  - **B#2 — Tempo de antecipação (Qualidade B):** análise da distribuição temporal dos TPs revela **50% são detecções diretas** (próprio evento é DG, antecipação=0) e **50% antecipações reais** com mediana de **5,7 min**, P75=56 min, P90=146 min. **Apenas 18% atingem janela de mobilização (90 min).** **Nova limitação L12** registrada — modelo é mais "detector de DG iminente" que "antecipador 4h". Mitigações em CM 6.3: target mais longo (8-12h), uso da Frente 2 (Weibull AFT) para horizontes amplos.
