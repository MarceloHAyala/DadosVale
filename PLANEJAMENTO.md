...
- [ ] **T1.2 Reconciliar L12 (antecipação curta) com as horas evitáveis (figNeg03).** Usar o cenário **conservador** como manchete, não o otimista. Declarar explicitamente: "50% dos acertos são detecção direta (antecipação 0), só ~18% dão os 90 min de mobilização". Apontar a tensão antes que o avaliador a descubra. O título do desafio é "Antecipação"; ser franco sobre o lead time real é mandatório.
