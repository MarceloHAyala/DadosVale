...
uv run python Projeto/codigo/23_antecedencia_vs_acuracia.py # W7 (L12, 07/06) - **Antecipação inclusiva (preliminar)**. Alvo "DG em [t+L,t+4h]" para L=0..120min. AUC-ROC 0,91 em L=90min — porém INFLADO por acerto via DG mais próximo (ver script 25/26). → antecedencia_vs_acuracia.csv + figExJ (superada pela figExK). Tempo: ~30 s
