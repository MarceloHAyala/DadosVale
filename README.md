...
uv run python Projeto/codigo/08d_comparacao_horizontes_cv.py # W7 (Grupo B#1) - **Comparação T2/T4/T8 via TimeSeriesSplit CV** com hiperparâmetros fixos do v3. Valida ou refuta a escolha do horizonte 4h vs alternativas. Cenário 1 (T2 ≈ T4 indistinguíveis) confirma CM 1.2; Cenário 2 (T2 > T4 com >2σ) vira Insight CM 6.1. → comparacao_horizontes_cv.csv. Tempo: ~6 min
```
